...
def run_import(get_spark, job_info: dict[str, Any], metadata: dict[str, Any]):
    ...
    Open questions:
        ...
        * If a type in the input isn't coercible into the target column type, spark will
    ...
    Assumptions
        ...
        * We want to overwrite any duplicate filenames in the existing table
    ...
    # between checking the crc and loading the file into the table
    ...
    # coerce schema to match the target table, needs to happen AFTER the column existence check
    columns = [
